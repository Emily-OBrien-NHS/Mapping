...
worksheet.write_formula('B4', "=IFERROR(VLOOKUP(B2,'Band Data'!A:H,2,0), 0)", center_border)
worksheet.write_formula('B5', "=IFERROR(VLOOKUP(B2,'Band Data'!A:H,3,0), 0)", center_border)
worksheet.write_formula('B6', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:H,4,0), "-")''', center_border)
worksheet.write_formula('B7', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:H,5,0), "-")''', center_border)
worksheet.write_formula('B8', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:H,6,0), "-")''', percent_format)
worksheet.write_formula('B9', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:H,7,0), "-")''', percent_format)
worksheet.write_formula('B10', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:H,8,0), "-")''', center_border)
...
for i in range(13,25):
     #Headcount
     worksheet.write_formula(f'B{i}',f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,4,0), 0)''', center_border)
     #FTE
     worksheet.write_formula(f'C{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,5,0), 0)''', center_border)
     #Average Time in Position
     worksheet.write_formula(f'D{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,6,0), "-")''', center_border)
     #Longest Time in Position
     worksheet.write_formula(f'E{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,7,0), "-")''', center_border)
     #Proportion of Total Headcount
     worksheet.write_formula(f'F{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,8,0), "-")''', percent_format)
     #Proportion of FTE
     worksheet.write_formula(f'G{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,9,0), "-")''', percent_format)
     #Pension Opt Out
     worksheet.write_formula(f'H{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:J,10,0), "-")''', center_border)

#Add in bar charts
headcount_chart = workbook.add_chart({'type':'column'})
headcount_chart.add_series({'name':'Filter!$B$12',
...
pension_chart.add_series({'name':'Filter!$H$12',
                            'categories': 'Filter!$A$13:$A$24',
...
band_worksheet.set_column(1, 7, 11, center)
band_worksheet.set_column(5, 6, 16, percent_format2)
...
age_worksheet.set_column(2, 10, 11, center)
age_worksheet.set_column(7, 8, 16, percent_format2)
