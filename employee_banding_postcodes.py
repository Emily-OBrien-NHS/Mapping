...
band_name = group_by_band(df, ['Banding'])
age_band = group_by_band(df, ['Banding', 'AgeBand'])
...
worksheet.write_formula('B4', "=IFERROR(VLOOKUP(B2,'Band Data'!A:E,2,0), 0)", center_border)
worksheet.write_formula('B5', "=IFERROR(VLOOKUP(B2,'Band Data'!A:E,3,0), 0)", center_border)
worksheet.write_formula('B6', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:E,4,0), "-")''', center_border)
worksheet.write_formula('B7', '''=IFERROR(VLOOKUP(B2,'Band Data'!A:E,5,0), "-")''', center_border)
...
for i in range(11,23):
     #Headcount
     worksheet.write_formula(f'B{i}',f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:G,4,0), 0)''', center_border)
     #FTE
     worksheet.write_formula(f'C{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:G,5,0), 0)''', center_border)
     #Average Time in Position
     worksheet.write_formula(f'D{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:G,6,0), "-")''', center_border)
     #Longest Time in Position
     worksheet.write_formula(f'E{i}', f'''=IFERROR(VLOOKUP((B2&" "&A{i}),'Age Band Data'!A:G,7,0), "-")''', center_border)
...
worksheet.insert_chart('G2', headcount_chart, {'x_scale':1.04, 'y_scale':1.07})
